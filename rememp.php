<!DOCTYPE html>
	<html lang = "pt-br">
	<head>
		<title>Vikings Taberna-Remover empresas</title>
	...
	<body>
		...
		<div class = "container">
			<form action = "remempbanco.php" method = "POST" accept-charset = "utf-8" class = "form-login" enctype ="multipart/form-data">
				<h2 class = "form-login-heading">Remover empresas</h2><br>
				<div class ="row">
				<?php
					include("conexao.php");
					...
					while($aux2 = pg_fetch_assoc($resultado)){
						echo '<div class="col-xs-6 col-md-6">
								<label class = "text-center"> '.$aux2["rsocial"].' - '.$aux2["cnpj"].' <input type="radio" name="emp" id="emp" value="'.$aux2	["cnpj"].'" class = "form-control" autofocus><br>&nbsp;&nbsp;&nbsp;&nbsp;
							</div>';
					}
				?>
				</div>
