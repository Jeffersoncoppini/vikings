<!DOCTYPE html>
	<html lang = "pt-br">
	<head>
		<title>Vikings Taberna-Remover atrações</title>
	...
	<body>
					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							...
							<ul class="dropdown-menu inverse-dropdown">
								...
								<li><a href="cadperfil.php">Criar usuário</a></li>
							</ul>
						</li>
		...
		<div class = "container">
			...
			<?php
				...
				if(isset($_SESSION['erroatrac'])){
					echo $_SESSION['erroatrac'];
					unset($_SESSION['erroatrac']);
				}
