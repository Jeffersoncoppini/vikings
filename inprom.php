	...
	<body>
		...
		<div class = "container">
			<form action = "inprombanco.php" method = "POST" accept-charset = "utf-8" class = "form-login" enctype ="multipart/form-data">
				...
				<input type = "date" id = "datai" name = "datai" class = "form-control" placeholde = "datai"required autofocus></br>
				
				<label for = "dataf"> Data final:</label>
				<input type = "date" id = "dataf" name = "dataf" class = "form-control" placeholde = "dataf"required autofocus></br>
				
				<label for = "desc">Descrição:</label>
				<input type = "text" id = "desc" name = "desc" class = "form-control" placeholde = "desc" required autofocus><br>
				
				<label for = "precopromo"> Preço:</label>
				<input type = "number" step = 0.01 id = "precopromo" name = "precopromo" class = "form-control" placeholde = "Precopromo" required autofocus></br>
