<!DOCTYPE html>
	<html lang = "pt-br">
	<head>
		<title>Vikings Taberna-Remover anuncios</title>
	...
	<body>
		...
		<div class = "container">
			<form action = "remanunbanco.php" method = "POST" accept-charset = "utf-8" class = "form-login" enctype ="multipart/form-data">
				<h2 class = "form-login-heading">Remover anuncios</h2><br>
				<div class ="row">
				<?php
					$bdcon = pg_connect("dbname=Vikings port=5432 user=postgres password=jukajeffe") or die("erro de conexão");
					$resultado = pg_query($bdcon,"SELECT * FROM anuncio");
			...
			<?php
				if(isset($_SESSION['okanun'])){
					echo $_SESSION['okanun'];
					unset($_SESSION['okanun']);
				}
