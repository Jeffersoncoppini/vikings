<!DOCTYPE html>
	<html lang = "pt-br">
	<head>
		<title>Vikings Taberna-Cadastro de anuncios</title>
		...
		<p class = "text-center">
			<?php
				if(isset($_SESSION['okanuncio'])){
					...
					unset($_SESSION['okanuncio']);
				}
				if(isset($_SESSION['erroanuncio'])){
					echo $_SESSION['erroanuncio'];
					unset($_SESSION['erroanuncio']);
				}
